...
# Script para convertir videos a formato H.264 compatible con Safari
echo "🍎 Convirtiendo videos para compatibilidad con Safari..."
...
convert_video() {
    ...
    # Convertir a H.264 Main Profile (compatible con Safari)
    ffmpeg -i "$input_file" \
